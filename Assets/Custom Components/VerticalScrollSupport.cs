...
{
    [AddComponentMenu("UI/Vertical Scroll Rect Support", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </remarks>
    public class ScrollRect1 : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup 
        //, IPointerClickHandler
    {
        ...
        public Vector2 m_ContentStartPosition = Vector2.zero;
...
#pragma warning restore CS0414
        ...
        //        else
        //        {
        //            // Debug.Log("storedVelocityX is zero, snapping not started.");
        //        }
        //    }
        ...
        public void Begun(UnityEngine.InputSystem.EnhancedTouch.Touch touch)
        {
            if (!IsActive()) return;
            UpdateBounds();
            m_PointerStartLocalCursor = Vector2.zero;
        ...
        public void Moved(UnityEngine.InputSystem.EnhancedTouch.Touch touch)
        {
...
#pragma warning disable CS0414
        ...
        bool AbleToGoBeyondBorder = false;
                ...
                if (!m_Dragging && (offset != Vector2.zero || m_Velocity != Vector2.zero))
                {
                    ...
                    for (int axis = 0; axis < 2; axis++)
                    {
                        ...
                        if (m_MovementType == MovementType.Elastic && offset[axis] != 0)
                        {
                            ...
                            if (m_Scrolling) smoothTime *= 3.0f;
